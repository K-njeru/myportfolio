...
//service pop ups for each respective button
...
const circleElements = document.querySelectorAll('.circle');
    ...
    function countPercentage(percentageElement, desiredPercentage) {
      ...
      function updatePercentage(timestamp) {
        ...
        const interpolatedPercentage = Math.round(progress * desiredPercentage);
        percentageElement.textContent = interpolatedPercentage + '%';
    ...
    function handleScroll() {
      circleElements.forEach((circleElement, index) => {
        ...
        const desiredPercentage = circleData[index].percentage;
        ...
        if (elementTop - windowHeight <= scrollY) {
          countPercentage(percentageElement, desiredPercentage);
        }
      });
    }
